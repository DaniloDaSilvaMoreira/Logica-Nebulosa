...
# Definindo as funções de pertinência para o Histórico de Crédito
...
# Definindo as funções de pertinência para a Renda Mensal
...
# Definindo as funções de pertinência para a Dívida Atual
...
# Definindo as funções de pertinência para o Risco
